// // import 'package:unity_message_ui/src/extensions/int_extension.dart';
//
// import '../../../infospect_network_call.dart';
// import 'details_topic_data.dart';
//
...
//     }
//
//     if (call.request?.body != null && (call.request?.bodyMap ?? {}).isNotEmpty) {
//       _setupBodyTopics();
//     }
//   }
//
...
//             other: call.response != null ? 'Received: ${call.response!.size.toReadableBytes}' : '',
//           ),
//           (
//             title: "Client:",
...
//       body: TopicDetailsBodyMap(
//         map: {for (var e in call.request!.formDataFiles!) e.fileName ?? '': '${e.contentType} / ${e.length} B'},
//       )
//     );
//   }
//
