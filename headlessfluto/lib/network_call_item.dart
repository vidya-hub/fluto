...
import 'package:headlessfluto/conditional_widget.dart';
import 'package:headlessfluto/highlight_text_widget.dart';
import 'package:headlessfluto/model/network_model.dart';
import 'package:headlessfluto/utils/datetime_extension.dart';
import 'package:headlessfluto/utils/int_extension.dart';


class NetworkCallItem extends StatelessWidget {
  final NetworkCallModel networkCall;
...
class _StatusIndicatorWidget extends StatelessWidget {
  ...
  Color? getStatusTextColor(NetworkNetworkResponse? response, BuildContext context) {
